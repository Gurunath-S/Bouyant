    ...
    <div className="max-w-3xl mx-auto space-y-6">
      <div className="flex items-center justify-between border-b border-slate-200 dark:border-slate-800 pb-4">
        <div>
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">Real-time alerts for stall holds, payment confirmations, and invoices.</p>
        </div>
      ...
      {loading ? (
        <div className="p-12 text-center text-slate-500 dark:text-slate-400 font-medium animate-pulse">Loading Alerts...</div>
        ...
        <div className="p-12 text-center bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl space-y-2">
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400">You are all caught up on system updates.</p>
        </div>
      ) : (
            ...
            <div
              ...
              className={`p-4 rounded-xl border flex items-start gap-4 transition-all ${
                n.isRead
                  ...
                  : 'bg-blue-50/50 dark:bg-blue-950/40 border-blue-200 dark:border-blue-800 shadow-2xs'
              }`}
            >
